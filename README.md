...
### Сопоставление размеров программы
...
Вывод: оптимизированная программа имеет меньший размер, чем программа => удалась не только оптимизация по скорости (это проверим дальше), но и по размеру :)